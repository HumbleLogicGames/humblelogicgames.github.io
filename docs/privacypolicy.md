...
We may ask for your approval to collect other information in some circumstances from you or your device. If this situation arises, we will inform you what information we are to collect, the reason we collect it, and how we will be using that information.
...
We collect information using analytics tools to see how you play our games or use our Services. Those tools may contain cookies or other similar tracking technologies. We may use your data for research and analytics purposes to engage with you directly. We may also create reports, analysis or similar services for use by us for the purposes of research or business intelligence.

We use **Google Firebase Analytics** to collect gameplay and usage data. Aggregated event data may be exported to **Google BigQuery** for internal analysis and product improvement. This data is processed in accordance with Google's privacy policy: https://policies.google.com/privacy
...
We use **Google AdMob's User Messaging Platform (UMP)** as our Consent Management Platform (CMP) to collect and manage user consent for personalized advertising in accordance with GDPR and other applicable privacy regulations. On iOS devices, we also request App Tracking Transparency (ATT) permission as required by Apple. Users may update their consent preferences at any time through the in-app settings menu.
